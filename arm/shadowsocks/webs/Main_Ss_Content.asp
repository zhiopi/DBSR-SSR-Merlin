							...
							<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle">
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										...
										<div class="SimpleNote" id="head_illustrate">点击直达：<a href="https://www.dbsr.cf" target="_blank"><em><u>菠萝云官网</u></em></a>；问题反馈：<a href="mailto:admin@dbsr.cf" target="_blank"><em><u>站长邮箱</u></em></a>；插件下载：<a href="https://www.dbsr.cf" target="_blank"><em><u>下载页面</u></em></a>。</div>
