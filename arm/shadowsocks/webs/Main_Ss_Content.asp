	...
	require(['/res/layer/layer.js'], function(layer) {
		layer.open({
			...
			content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">\
				<b>梅林固件 - 菠萝云插件 - ' + db_ss["ss_basic_version_local"] + '</b><br><br>\
				本插件是支持<a target="_blank" href="https://github.com/shadowsocks/shadowsocks-libev" ><u>SS</u></a>、<a target="_blank" href="https://github.com/shadowsocksrr/shadowsocksr-libev"><u>SSR</u></a>、<a target="_blank" href="http://firmware.koolshare.cn/binary/koolgame"><u>KoolGame</u></a>、<a target="_blank" href="https://github.com/v2ray/v2ray-core"><u>V2Ray</u></a>四种客户端的菠萝云、游戏加速工具。<br>\
...
function toggle_func() {
	...
	$("#update_log").click(
		function() {
			window.open("https://github.com/zhiopi/DBSR-SSR-Merlin/blob/master/arm/Changelog.txt");
		});
	$("#log_content2").click(
		function() {
			x = -1;
							...
							<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle">
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										<div>&nbsp;</div>
										<div class="formfonttitle">梅林固件 - 菠萝云插件</div>
										<div style="float:right; width:15px; height:25px;margin-top:-20px">
											<img id="return_btn" onclick="reload_Soft_Center();" align="right" style="cursor:pointer;position:absolute;margin-left:-30px;margin-top:-25px;" title="返回软件中心" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'"></img>
										</div>
										<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
                                        <div class="SimpleNote" id="head_illustrate">点击直达：<a href="https://www.dbsr.cf" target="_blank"><em><u>菠萝云官网</u></em></a>；问题反馈：<a href="mailto:admin@dbsr.cf" target="_blank"><em><u>站长邮箱</u></em></a>；插件下载：<a href="https://www.dbsr.cf" target="_blank"><em><u>下载页面</u></em></a>。</div>										<div style="margin-top: 0px;text-align: center;font-size: 18px;margin-bottom: 0px;" class="formfontdesc" id="cmdDesc"></div>
												...
												<th id="ss_switch"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(10)">菠萝云开关</a></th>
													<td colspan="2">
														...
														<div style="display:table-cell;float: left;margin-left:270px;position: absolute;padding: 5.5px 0px;">
															<a type="button" class="ss_btn" target="_blank" href="https://github.com/zhiopi/DBSR-SSR-Merlin/blob/master/arm/Changelog.txt">更新日志</a>
														</div>
