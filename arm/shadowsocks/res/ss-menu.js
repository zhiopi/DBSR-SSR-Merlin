...
function LoadingSSProgress(seconds) {
	...
	if (action == 0) {
		...
		$("#loading_block2").html("<li><font color='#ffcc00'><a href='https://www.dbsr.cf' target='_blank'></font>插件工作有问题？请到<em>菠萝云</em>提交issue...</font></li>");
	} else if (action == 1) {
		...
		$("#loading_block2").html("<li><font color='#ffcc00'>此期间请勿访问屏蔽网址，以免污染DNS进入缓存</font></li><li><font color='#ffcc00'>此模式非菠萝云方式，会影响国内网页速度...</font></li><li><font color='#ffcc00'>注意：全局模式并非VPN，只支持TCP流量转发...</font></li><li><font color='#ffcc00'>请等待日志显示完毕，并出现自动关闭按钮！</font></li><li><font color='#ffcc00'>在此期间请不要刷新本页面，不然可能导致问题！</font></li>");
	} else if (action == 6) {
...
function openssHint(itemNum) {
	...
	if (itemNum == 0) {
		...
		statusmenu += "</br><b><font color='#CC0066'>6：你遇到了非常少见的情况：</font></b>来这里反馈吧：<a href='https://www.dbsr.cf' target='_blank'><u><font color='#00F'>telegram</font></u></a>。"
		_caption = "状态检测";
	...
	if (itemNum == 1) {
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://raw.githubusercontent.com/zhiopi/DBSR-SSR-Merlin/master/history/shadowsocks_4.1.4.tar.gz";
		...
		statusmenu += "</br>回滚其它版本号，请参考<a href='https://github.com/zhiopi/DBSR-SSR-Merlin/tree/master/history' target='_blank'><u><font color='#00F'>版本历史列表</font></u></a>";
