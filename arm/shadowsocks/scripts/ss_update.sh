...
main_url="https://raw.githubusercontent.com/zhiopi/DBSR-SSR-Merlin/master/arm/"
backup_url=""
...
update_ss2(){
	...
	echo_date "历史版本下载地址：https://github.com/zhiopi/DBSR-SSR-Merlin/tree/master/arm/history"
